...
* MySQL Community Edition 8.0.21版（來自MySQL儲存庫）。請確定您已移除任何先前安裝的MySQL 5.7版本。由於互通性問題、Unified Manager安裝程式僅限支援MySQL Community Edition 8.0.21。您不得*將MySQL升級至8.0.21以上的版本。
